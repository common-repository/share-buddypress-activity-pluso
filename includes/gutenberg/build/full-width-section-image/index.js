...
/***/ "./includes/gutenberg/src/full-width-section-image/edit.js":
/*!*****************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/edit.js ***!
  \*****************************************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./includes/gutenberg/src/full-width-section-image/block.json");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./includes/gutenberg/src/full-width-section-image/editor.scss");
...
function edit({
  ...
  const [isImageToRight, setImageToRight] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  ...
  // side image
  const sideImageData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.useSelect)(select => {
  ...
  return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Side Image', 'heebos'),
    initialOpen: true
  ...
  }, attributes?.sideImageUrl ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "mxdnsms-cover-image-wrapper"
  ...
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.CheckboxControl, {
    ...
    className: "wp-block-mxdnsms-full-width-section-image--image-wrapper"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("img", {
    src: attributes.sideImageUrl,
    "data-side-image-id": attributes.sideImageId,
    alt: "",
    className: "mx-side-img"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "wp-block-mxdnsms-full-width-section-image--content-wrapper"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "wp-block-mxdnsms-full-width-section-image--text"
...
/***/ "./includes/gutenberg/src/full-width-section-image/index.js":
/*!******************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./includes/gutenberg/src/full-width-section-image/block.json");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./includes/gutenberg/src/full-width-section-image/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./includes/gutenberg/src/full-width-section-image/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./includes/gutenberg/src/full-width-section-image/save.js");
...
/***/ "./includes/gutenberg/src/full-width-section-image/save.js":
/*!*****************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/save.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./includes/gutenberg/src/full-width-section-image/editor.scss":
/*!*********************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/editor.scss ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./includes/gutenberg/src/full-width-section-image/style.scss":
/*!********************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/style.scss ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./includes/gutenberg/src/full-width-section-image/block.json":
/*!********************************************************************!*\
  !*** ./includes/gutenberg/src/full-width-section-image/block.json ***!
  \********************************************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"mxdnsms/full-width-section-image","version":"0.1.0","title":"Full width section (Side Image)","category":"widgets","icon":"align-wide","description":"Add a Full width section","supports":{"html":false,"align":["left","right","full"],"anchor":true,"color":{"gradients":true,"link":true,"__experimentalDefaultControls":{"background":true,"text":true}}},"attributes":{"align":{"type":"string","default":""},"mediaBGId":{"type":"string","source":"attribute","selector":"div","attribute":"data-image-id","default":null},"mediaBGUrl":{"type":"string","source":"attribute","selector":"div","attribute":"data-image-url","default":null},"sideImageUrl":{"type":"string","source":"attribute","selector":".mx-side-img","attribute":"src","default":null},"sideImageId":{"type":"string","source":"attribute","selector":".mx-side-img","attribute":"data-side-image-id","default":null},"imageToRight":{"type":"string","source":"attribute","selector":"div","attribute":"data-image-to-right","default":"0"}},"textdomain":"mxdnsms-domain","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"full-width-section-image/index": 0,
/******/ 			"full-width-section-image/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["full-width-section-image/style-index"], () => (__webpack_require__("./includes/gutenberg/src/full-width-section-image/index.js")))
